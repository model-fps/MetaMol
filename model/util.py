...
from model.maml import LSLRGradientDescentLearningRule
...
class RegressorBase(nn.Module):
    ...
    # Calculate cosine similarity between 2 matrix
    ...
    # Calculate tanimoto similarity between 2 matrix
    ...
    # Calculate the weight of the loss at each step in the inner loop
    ...
    # Perform internal gradient update on the model parameters
    ...
    # The loss values of multiple tasks are weighted averaged to obtain a total loss value
    ...
    def inner_loop(self, x_task, y_task, target_assay_idx, split, is_training_phase, epoch, num_steps):
        task_losses = []
    ...
    def load_model(self, model_save_path, model_name, model_idx):

        filepath = os.path.join(model_save_path, "{}_{}".format(model_name, model_idx))
